...
public class Utility extends ManageDriver {
     ...
     */
    public void clickOnElement(By by) {  //  overload method eith with  passby or elements // locators
        WebElement element = driver.findElement(by);
        element.click(); // perform
    }

    public void clickOnElement(WebElement element) { //  overload method eith with  passby or elements // element
        element.click();
    }
